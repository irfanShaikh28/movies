...
MongoClient.connect(url, function(err, db) {
  ...
  var dbo = db.db("mydb");
  var myobj = [
    { name: 'Harry Potter and the Order of the Phoenix', img: 'https://bit.ly/2IcnSwz',summary: 'Harry Potter and Dumbledores warning about the return of Lord Voldemort is not heeded by the wizard authorities who, in turn, look to undermine Dumbledores authority at Hogwarts and discredit Harry.'},
